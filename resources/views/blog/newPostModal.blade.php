<div class="modal inmodal fade" id="modal-form" tabindex="-1" role="dialog"  aria-hidden="true">
  <div class="modal-dialog modal-lg">
      <div class="modal-content">
          ...
          <form id="tambah-post" method="POST" action="{{ route('blog-create-post') }}" class="form-horizontal" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <textarea type="text" class="form-control" required name="detail" placeholder="Detail post" id="detail" rows="20"></textarea>
                  </div> 
              </div>
              <div class="form-group row">
